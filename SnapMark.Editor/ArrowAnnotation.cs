...
public class ArrowAnnotation : AnnotationBase
{
    ...
    public ArrowAnnotation(Point start, Point end) : base(new Rectangle(start, new Size(end.X - start.X, end.Y - start.Y)))
    {
        StartPoint = start;
        EndPoint = end;
        UpdateBounds();
    ...
    public override bool HitTest(Point point)
    {
        ...
        return distance <= StrokeWidth + 5; // 5 pixel tolerance
    }
